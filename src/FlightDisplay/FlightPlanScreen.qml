    ...
    Rectangle {
        ...
        Rectangle {
            ...
            Text {
                ...
                text: "Pilih Mode Terbang"
                font.pixelSize: parent.height * 0.03
                color: qgcPal.colorGrey
            }
            Button {
                // anchors.top: tittleText.bottom
                anchors.verticalCenter: parent.verticalCenter
                anchors.left: parent.left
                // anchors.topMargin: 20
                anchors.leftMargin: 20
                ...
                Text {
                    ...
                    text: "Zig Zag"
                    color: qgcPal.mapMissionTrajectory
                    font.pixelSize: tittleText.font.pixelSize  // Font size based on overlay height
                    // font.bold: true
                }
                onClicked: {
                    zigzagButton.border.width = 3
                    spiralButton.border.width = 1
                }
            }
            Button {
                // anchors.top: tittleText.bottom
                ...
                onClicked: {
                    spiralButton.border.width = 3
                    zigzagButton.border.width = 1

                }
            }

            Text {
                anchors.bottom: planLanjutButton.top
                anchors.bottomMargin: 20
                anchors.left: parent.left
                anchors.leftMargin: 20
                anchors.rightMargin: 20
                wrapMode: Text.WordWrap
                text: "Pilihlah mode yang diinginkan dan lanjut untuk memilih area yang dilalui."
                color: qgcPal.colorGrey
                font.pixelSize: parent.height * 0.03
            ...
            Button {
                ...
                onClicked: {
                    ...
                    flightplanScreen.visible = false
                }
            }
        }
    }
