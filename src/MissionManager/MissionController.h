...
public:
    ...
    Q_INVOKABLE VisualMissionItem* insertVtolTakeoffItem(QGeoCoordinate coordinate, int visualItemIndex, bool makeCurrentItem = false);
    Q_INVOKABLE VisualMissionItem* insertVtolTransitionItem(QGeoCoordinate coordinate, int visualItemIndex, bool transitionToFixedWing, bool makeCurrentItem = false);
    ...
    Q_INVOKABLE VisualMissionItem* insertVtolLandItem(QGeoCoordinate coordinate, int visualItemIndex, bool makeCurrentItem = false);
