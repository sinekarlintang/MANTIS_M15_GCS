...
void QGCPalette::_buildMap()
{
    ...
    DECLARE_QGC_COLOR(window,               "#ffffff", "#5072fa", "#05014f", "#000000")
    DECLARE_QGC_COLOR(windowShadeLight,     "#909090", "#828282", "#707070", "#626262")
    DECLARE_QGC_COLOR(windowShade,          "#5072fa", "#5072fa", "#05014f", "#212121")
    DECLARE_QGC_COLOR(windowShadeDark,      "#bdbdbd", "#bdbdbd", "#05014f", "#212121")
    DECLARE_QGC_COLOR(text,                 "#9d9d9d", "#000000", "#707070", "#e8e8e8")
    DECLARE_QGC_COLOR(warningText,          "#cc0808", "#cc0808", "#f85761", "#f85761")
    DECLARE_QGC_COLOR(button,               "#ffffff", "#ffffff", "#707070", "#02426d")
    DECLARE_QGC_COLOR(buttonText,           "#9d9d9d", "#000000", "#A6A6A6", "#e8e8e8")
    DECLARE_QGC_COLOR(buttonHighlight,      "#e4e4e4", "#946120", "#3a3a3a", "#79cbe8")
    ...
    DECLARE_QGC_COLOR(missionItemEditor,    "#585858", "#dbfef8", "#585858", "#02426d")
    DECLARE_QGC_COLOR(toolStripHoverColor,  "#585858", "#9D9D9D", "#585858", "#5c5c5c")
    ...
    DECLARE_QGC_COLOR(toolbarBackground,    "#ffffff", "#8389fc", "#222222", "#000000")
